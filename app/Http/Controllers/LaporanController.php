...
class LaporanController extends Controller
{
    ...
    {
        // Validasi input (mengganti 'lokasi' dengan 'lokasi_awal' dan 'lokasi_akhir')
        $validator = Validator::make($request->all(), [
            'jenis_laporan' => 'required',
            'bukti_laporan' => 'required|file|max:51200',
            'lokasi_awal' => 'required',
            'lokasi_akhir' => 'required',
            'ciri_khusus_lokasi' => 'nullable',
        ...
        try {
            // Buat laporan baru dengan kolom lokasi_awal dan lokasi_akhir
            $laporan = new Laporan();
    ...
    public function update(Request $request, $id)
    {
        ...
        // Validasi diperbarui untuk kolom lokasi_awal & lokasi_akhir
        $validator = Validator::make($request->all(), [
            'jenis_laporan' => 'required',
            'lokasi_awal' => 'required',
            'lokasi_akhir' => 'required',
